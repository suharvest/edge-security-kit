"""CLI entry point: ``python -m esk_rknn --config config.yaml``."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="esk_rknn", description=__doc__)
    ...
    parser.add_argument(
        "--validate",
        action="store_true",
        help="load the model and the config, then exit without connecting",
    )
